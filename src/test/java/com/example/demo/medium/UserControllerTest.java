...
public class UserControllerTest {
    ...
    void 사용자는_특정_유저의_정보를_전달_받을_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/{id}", 1L))
                ...
                .andExpect(jsonPath("$.email").value("jeongjy620@gmail.com"))
    ...
    void 사용자는_존재하지_않는_유저의_아이디로_api_호출할_경우_404_응답을_받는다() throws Exception {
        ...
        // when
        // then
        mockMvc.perform(get("/api/users/{id}", 1123L))
                .andExpect(status().isNotFound())
                .andExpect(content().string("Users에서 ID 1123를 찾을 수 없습니다."));
    }
    ...
    void 사용자는_인증_코드로_계정을_활성화할_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/2/verify")
                        .queryParam("certificationCode", "aaaa-aaaaa-aaaaaa2"))
    ...
    void 사용자는_내_정보를_수정할_수_있다() throws Exception {
        ...
        mockMvc.perform(put("/api/users/me")
                ...
                .andExpect(jsonPath("$.id").value(1L))
                .andExpect(jsonPath("$.email").value("jeongjy620@gmail.com"))
                .andExpect(jsonPath("$.nickname").value("jeongjy-n"))
    ...
    void 사용자는_인증_코드가_일치하지_않을_경우_권한_없음_에러를_내려준다() throws Exception {
        ...
        // then
        mockMvc.perform(get("/api/users/2/verify")
                        .queryParam("certificationCode", "aaaa-aaaaa-aaaaaa22"))
